...
namespace MinimalAPI_Reconocimiento.Configurations
{
    ...
    {
        [System.Obsolete]
        public static IServiceCollection ConfigureLogger(this IServiceCollection services, ConfigurationManager configuration, WebApplicationBuilder builder)
        {
            #region Logging
            ...
            _ = builder.Host.UseSerilog((hostContext, loggerConfiguration) =>
            {
                ...
                _ = loggerConfiguration.WriteTo.MSSqlServer(connectionString: configuration.GetConnectionString("SqlConnection"),
            ...
            var test = configuration.GetConnectionString("SqlConnection");
